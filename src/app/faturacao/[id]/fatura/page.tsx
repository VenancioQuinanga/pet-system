                ...
                <div ref={printRef} className={`${Styles.invoice} mt-0`}>
                  ...
                  <div className="d-flex mb-5">
                    ...
                    <div className='ms-auto mt-5 pt-4 pe-5'>
                      ...
                      <p>{sales?.['tb_sale.tb_client.nif'] !== null ? sales?.['tb_sale.tb_client.nif'] : sales.client_nif}</p>
                    </div>
                  </div>
                  ...
                  <table className={`${Styles.invoice_table} invoice-border-full`}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{sales?.['tb_sale.tb_client.nif'] !== null ? sales?.['tb_sale.tb_client.nif'] : sales.client_nif}</td>
                        <td>{sales?.code}</td>
                      </tr>
                    </tbody>
                  </table>

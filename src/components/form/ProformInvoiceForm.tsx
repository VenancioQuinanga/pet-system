...
export default function ProformInvoiceForm(props: SalesFormInterface | any) {
  
  return (
    <>
      <section className="col-md-12 m-auto mb-4">
        <div className="lead text-primary mb-5 center">
          <span className="display-5 font-weight-bold">Gerar F.Proforma</span>
        </div>
